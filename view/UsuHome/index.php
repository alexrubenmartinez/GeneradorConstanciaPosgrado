...
<html lang="es">
  <head>
    ...
    <title>Posgrado UNSCH::Home</title>
  </head>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="bg-teal rounded overflow-hidden">
              <div class="pd-25 d-flex align-items-center">
                ...
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">Total de Documentos</p>
            ...
            <div class="card pd-0 bd-0 shadow-base">
              <div class="pd-x-30 pd-t-30 pd-b-15">
                <div class="d-flex align-items-center justify-content-between">
                  <div>
                    <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1">Top Ultimos Documentos</h6>
                  ...
                  <table id="documentos_data" class="table display responsive nowrap">
                    <thead>
                      ...
                      <th class="wd-15p">Documento</th>
                        ...
                        <th class="wd-15p">Fecha Creación</th>
