<div id="modalmantenimiento" class="modal fade" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content bd-0">
            ...
            <form method="post" id="documentos_form">
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control tx-uppercase" id="doc_nom" type="text" name="doc_nom" required/>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Descripcion: <span class="tx-danger">*</span></label>
                            <textarea class="form-control tx-uppercase" id="doc_descrip" type="text" name="doc_descrip" required></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Fecha Inicio: <span class="tx-danger">*</span></label>
                            <input class="form-control tx-uppercase" id="doc_fechini" type="date" name="doc_fechini" required/>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Fecha Fin: <span class="tx-danger">*</span></label>
                            <input class="form-control tx-uppercase" id="doc_fechfin" type="date" name="doc_fechfin" required/>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
