<div id="modalmantenimiento" class="modal fade" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content bd-0">
            ...
            <form method="post" id="posgrado_form">
                <div class="modal-body">
                    <input type="hidden" name="posg_id" id="posg_id"/>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control tx-uppercase" id="posg_nom" type="text" name="posg_nom" required/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control tx-uppercase" id="tipo" type="text" name="tipo" required/>
                        </div>
                    </div>

                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Mención: <span class="tx-danger">*</span></label>
                            <input class="form-control tx-uppercase" id="mencion" type="text" name="mencion" required/>
                        </div>
                    </div>
