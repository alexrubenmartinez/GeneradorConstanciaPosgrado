    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content bd-0">
                ...
                <table id="usuario_data" class="table display responsive nowrap">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="wd-20p">Ape.Paterno</th>
                            <th class="wd-20p">Ape.Materno</th>
            ...
            <div class="modal-footer">
                <button name="action" onclick="registrardetalle()" class="btn btn-outline-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium"><i class="fa fa-check"></i> Continuar</button>
