...
<html lang="es">
  <head>
    ...
    <title>POSGRADO UNSCH::Acceso</title>
  </head>
    ...
    <div class="d-flex align-items-center justify-content-center bg-br-primary ht-100v">
      <form action="" method="post">
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
          ...
          <div class="signin-logo tx-center tx-28 tx-bold tx-inverse"><span class="tx-normal">[</span>POSGRADO UNSCH<span class="tx-normal">]</span></div>

          <div class="tx-center mg-b-30">Generador de Constancias</div>

          <div class="form-group">
              <input type="text" id="usu_dni" name="usu_dni" class="form-control" placeholder="Ingrese DNI">
          </div>
          <div class="form-group">
