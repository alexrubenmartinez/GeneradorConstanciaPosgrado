    ...
    class Conectar{
        ...
        protected function Conexion(){
            try {
				...
				$conectar = $this->dbh = new PDO("mysql:local=localhost;dbname=certificado_posgrado","root","");
        ...
        public static function ruta(){
            //QA
            return "http://localhost/GeneradorConstancia/";
            //Produccion
            //return "http://diplomas.link.com/";
        }
